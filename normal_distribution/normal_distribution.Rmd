...
1.  The histogram for female biiliac (pelvic) diameter (`bii.di`) belongs to normal probability plot letter __.
3.  The histogram for female elbow diameter (`elb.di`) belongs to normal probability plot letter __.
5.  The histogram for general age (`age`) belongs to normal probability plot letter __.
7.  The histogram for female chest depth (`che.de`) belongs to normal probability plot letter __.
